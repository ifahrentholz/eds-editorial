    ...
    <div class="ls-example">
      <div class="lsg-colors">
        ...
        <div class="lsg-colors__colors">
          ...
          <div class="lsg-colors__color">
            <div class="lsg-colors__color-tile" style="background: #637a77;"></div>
            <p>teal</p>
          </div>
          <div class="lsg-colors__color">
            <div class="lsg-colors__color-tile" style="background: #dcd8c0;"></div>
            <p>moss</p>
          </div>
          <div class="lsg-colors__color">
            <div class="lsg-colors__color-tile" style="background: #e7cfb9; "></div>
            <p>blush</p>
          </div>
        </div>
      </div>
