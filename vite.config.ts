...
export default defineConfig(({ command, mode }) => {
  const { mainTsPath, mainScssPath, fontsScssPath, lazyStylesScssPath, sidekickLibOverridesScssPath } = config;
    ...
    build: {
      ...
      rollupOptions: {
        ...
        input: {
          ...
          sidekickLibOverrides: resolve(__dirname, sidekickLibOverridesScssPath),
          ...blocksEntries,
        },
        output: {
          dir: 'dist',
