import{u as b,f as O,w as m,i as T,s as I,x as D}from"./lit-element.XkUWx5ik.js";import{e as L,a as w,i as R,t as V}from"./unsafe-html.dKgBHtsI.js";const S="modulepreload",M=function(t){return"/"+t},g={},l=function(e,s,n){let r=Promise.resolve();if(s&&s.length>0){const o=document.getElementsByTagName("link");r=Promise.all(s.map(i=>{if(i=M(i),i in g)return;g[i]=!0;const c=i.endsWith(".css"),h=c?'[rel="stylesheet"]':"";if(!!n)for(let _=o.length-1;_>=0;_--){const d=o[_];if(d.href===i&&(!c||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${h}`))return;const a=document.createElement("link");if(a.rel=c?"stylesheet":S,c||(a.as="script",a.crossOrigin=""),a.href=i,document.head.appendChild(a),c)return new Promise((_,d)=>{a.addEventListener("load",_),a.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${i}`)))})}))}return r.then(()=>e()).catch(o=>{const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o})};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const k=t=>(e,s)=>{s!==void 0?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N={attribute:!0,type:String,converter:b,reflect:!1,hasChanged:O},x=(t=N,e,s)=>{const{kind:n,metadata:r}=s;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),o.set(s.name,t),n==="accessor"){const{name:i}=s;return{set(c){const h=e.get.call(this);e.set.call(this,c),this.requestUpdate(i,h,t)},init(c){return c!==void 0&&this.P(i,void 0,t),c}}}if(n==="setter"){const{name:i}=s;return function(c){const h=this[i];e.call(this,c),this.requestUpdate(i,h,t)}}throw Error("Unsupported decorator location: "+n)};function q(t){return(e,s)=>typeof s=="object"?x(t,e,s):((n,r,o)=>{const i=r.hasOwnProperty(o);return r.constructor.createProperty(o,i?{...n,wrapped:!0}:n),i?Object.getOwnPropertyDescriptor(r,o):void 0})(t,e,s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class v extends L{}v.directiveName="unsafeSVG",v.resultType=2;const j=w(v);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U=t=>t===null||typeof t!="object"&&typeof t!="function",K=t=>t.strings===void 0;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const u=(t,e)=>{var n;const s=t._$AN;if(s===void 0)return!1;for(const r of s)(n=r._$AO)==null||n.call(r,e,!1),u(r,e);return!0},f=t=>{let e,s;do{if((e=t._$AM)===void 0)break;s=e._$AN,s.delete(t),t=e}while((s==null?void 0:s.size)===0)},P=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(s===void 0)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),Z(e)}};function X(t){this._$AN!==void 0?(f(this),this._$AM=t,P(this)):this._$AM=t}function Y(t,e=!1,s=0){const n=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(e)if(Array.isArray(n))for(let o=s;o<n.length;o++)u(n[o],!1),f(n[o]);else n!=null&&(u(n,!1),f(n));else u(this,t)}const Z=t=>{t.type==V.CHILD&&(t._$AP??(t._$AP=Y),t._$AQ??(t._$AQ=X))};class z extends R{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,s,n){super._$AT(e,s,n),P(this),this.isConnected=e._$AU}_$AO(e,s=!0){var n,r;e!==this.isConnected&&(this.isConnected=e,e?(n=this.reconnected)==null||n.call(this):(r=this.disconnected)==null||r.call(this)),s&&(u(this,e),f(this))}setValue(e){if(K(this._$Ct))this._$Ct._$AI(e,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=e,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
...
//# sourceMappingURL=icon.bg6zFOnj.js.map
